...
export declare namespace Util {
    ...
    function UInt16BEToDecibel(input: number): number;
    function DecibelToUInt16BE(input: number): number;
    function IntToBalance(input: number): number;
    function BalanceToInt(input: number): number;
}
